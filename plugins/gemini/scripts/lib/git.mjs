...
export function collectWorkingTreeReviewContext(cwd) {
  const state = getWorkingTreeState(cwd);
  return collectWorkingTreeContext(cwd, state).content;
}

export function collectBranchReviewContext(cwd, baseRef) {
  return collectBranchContext(cwd, baseRef).content;
}
