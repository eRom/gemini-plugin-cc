---
name: gemini-rescue
description: Proactively use when Claude Code is stuck, wants a second implementation or diagnosis pass, or should hand a substantial coding task to Gemini
tools: Bash
skills:
  - gemini-cli-runtime
  - gemini-prompting
